    ...
    <div class="container">
        <div class="form-row">
            ...
            <div class="col-md-4 my-2  ">
                ...
                <input type="text" class="form-control form_first_name" name="firstname" id="validationDefault01" placeholder="First Name" value="" required>
            ...
            <div class="col-md-4 my-2 ">
                ...
                <input type="text" class="form-control form_last_name" name="lastname" id="validationDefault02 " placeholder="Last name" value="" required>
            ...
            <input type="submit" name="save" value="SAVE"  class="btn btn-success" style="width: 70%;" >
   <hr>
<form action="">
      <div class="row">
         <div class="col-lg-4">
            <label for="validationDefault01">Password</label>
                <input type="text" class="form-control form_password" name="password" id="validationDefault01" placeholder="Passworde" value="" required>
                 <div class="error"id="error_first_name">Error</div>
         </div>
         <div class="col-lg-4">
            <label for="validationDefault01">Confirm Password</label>
                <input type="text" class="form-control form_confirm_password" name="confirm_pass" id="validationDefault01" placeholder="Confirm Password" value="" required>
                 <div class="error"id="error_first_name">Error</div>
         </div>
